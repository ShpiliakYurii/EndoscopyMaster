...
<head>
  ...
  <title>Словник рекомендацій</title>
</head>
<body>
<div class="container">
  <t:head/>
  ...
  <div class="row content">
    ...
    <c:forEach items="${recomendationDictionary}" var="r">
      <div class="col-sm-12 top-border">
        <a href="${url}editRecomendation/${r.id}">${r.name}</a>
      </div>
    </c:forEach>
    <div class="col-sm-12 top-border">
      <form:form method="post" commandName="newRecomendation" action="${url}addNewRecomendation">
        <div class="col-sm-12">
